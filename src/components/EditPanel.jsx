...
export default function EditPanel({ formData, onFormChange, globalSignature, onGlobalSignatureChange, hasCertificateSelected, onSignatureClick, selectedCertificateId }) {
